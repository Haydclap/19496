# -*- coding: utf-8 -*-
"""
Created on Mon Jan 22 22:23:34 2024
...
def select_data(day):
    ...
    df = pd.read_csv(f'C:Filename/Multiclass/Flows/{day}/{day}_flows_{file_no}.csv',skiprows=range(1,data_no),nrows=100,dtype=dtypes)
...
def TestSelector(i):     
    ...
    number_attacks = 100000
    number_benign = 900000
    attacks = []
    benign = []
    acount = 0
    bcount = 0
    ...
    test_data.to_csv(f'Filename/TestData/RandomData_{i}_large.csv', index=False)
